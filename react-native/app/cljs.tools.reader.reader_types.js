...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26346 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26346(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26348 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26348(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26357 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26357(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26361 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26361(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26362 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26362(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26367 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26367(reader);
}
});
...
var G__26432 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26433 = s.append(c);
c = G__26432;
s = G__26433;
continue;
}
