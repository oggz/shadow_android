...
if((i < len)){
var k = (ks[i]);
var G__28353 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__28354 = (i + (1));
m = G__28353;
i = G__28354;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28094 = c;
var G__28094__$1 = (((G__28094 == null))?null:G__28094.prototype);
if((G__28094__$1 == null)){
return null;
} else {
return G__28094__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28101 = c;
var G__28101__$1 = (((G__28101 == null))?null:G__28101.prototype);
if((G__28101__$1 == null)){
return null;
} else {
return G__28101__$1.render;
}
})() == null)))));
});
...
var G__28143 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__28143) : reagent.impl.component.as_element.call(null,G__28143));
};
...
while (G__28386__i < G__28386__a.length) {G__28386__a[G__28386__i] = arguments[G__28386__i + 0]; ++G__28386__i;}
  args = new cljs.core.IndexedSeq(G__28386__a,0,null);
} 
return G__28384__delegate.call(this,args);};
G__28384.cljs$lang$maxFixedArity = 0;
G__28384.cljs$lang$applyTo = (function (arglist__28395){
...
var _STAR_current_component_STAR__orig_val__28145 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__28146 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__28146);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__28145);
}});
...
var c = this;
var G__28196_28430 = goog.object.get(c,"cljsRatom");
if((G__28196_28430 == null)){
} else {
reagent.ratom.dispose_BANG_(G__28196_28430);
}
...
var renders_28439 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_28440 = cljs.core.first(cljs.core.vals(renders_28439));
...
if((cljs.core.count(renders_28439) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_28439))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_28440)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_28440], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__28226 = o;
goog.object.set(G__28226,cljs.core.name(k),v);
...
var name = (function (){var G__28287 = fiber;
var G__28287__$1 = (((G__28287 == null))?null:G__28287.type);
if((G__28287__$1 == null)){
return null;
} else {
return G__28287__$1.displayName;
}
})();
var parent = (function (){var G__28288 = fiber;
if((G__28288 == null)){
return null;
} else {
return G__28288.return;
}
})();
var path = (function (){var G__28297 = parent;
var G__28297__$1 = (((G__28297 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__28297) : reagent.impl.component.fiber_component_path.call(null,G__28297)));
if((G__28297__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28297__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4126__auto__ = (function (){var G__28318 = c;
if((G__28318 == null)){
return null;
} else {
return goog.object.get(G__28318,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__28322._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4126__auto__ = (function (){var G__28325 = c;
if((G__28325 == null)){
return null;
} else {
return goog.object.get(G__28325,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var or__4126__auto____$1 = (function (){var G__28327 = c;
if((G__28327 == null)){
return null;
} else {
return G__28327._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4126__auto____$1)){
return or__4126__auto____$1;
...
var elem = (function (){var or__4126__auto__ = (function (){var G__28329 = instance;
if((G__28329 == null)){
return null;
} else {
return goog.object.get(G__28329,"_currentElement");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var G__28330 = instance;
if((G__28330 == null)){
return null;
} else {
return G__28330._currentElement;
}
}
})();
var name = (function (){var G__28331 = elem;
var G__28331__$1 = (((G__28331 == null))?null:G__28331.type);
if((G__28331__$1 == null)){
return null;
} else {
return G__28331__$1.displayName;
}
})();
var owner = (function (){var or__4126__auto__ = (function (){var G__28333 = elem;
if((G__28333 == null)){
return null;
} else {
return goog.object.get(G__28333,"_owner");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__28334._owner;
}
}
})();
var path = (function (){var G__28335 = owner;
var G__28335__$1 = (((G__28335 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__28335) : reagent.impl.component.component_path.call(null,G__28335)));
if((G__28335__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28335__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__28337 = c;
var G__28337__$1 = (((G__28337 == null))?null:G__28337.constructor);
if((G__28337__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__28337__$1);
}
}
})();
